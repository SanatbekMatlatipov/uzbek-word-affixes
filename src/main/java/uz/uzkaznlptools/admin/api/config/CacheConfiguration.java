package uz.uzkaznlptools.admin.api.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, uz.uzkaznlptools.admin.api.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, uz.uzkaznlptools.admin.api.repository.UserRepository.USERS_BY_EMAIL_CACHE);
