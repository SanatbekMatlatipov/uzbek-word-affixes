...
import { EndingsComponent } from 'app/entities/endings/endings.component';
import { EndingsService } from 'app/entities/endings/endings.service';
import { Endings } from 'app/shared/model/endings.model';

describe('Component Tests', () => {
  describe('Endings Management Component', () => {
    let comp: EndingsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EndingsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.endings && comp.endings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
