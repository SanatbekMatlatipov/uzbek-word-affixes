...
This application has been established for the development of Uzbek - Kazakh languages NLP tools.
...
To build the final jar and optimize the UzKazNlpTools application for production, run:
